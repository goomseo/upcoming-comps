<template>
  <div class="border-t pt-4 mt-4">
    ...
    <p><strong>WCA ID:</strong> <a :href="user.user.url" target="_blank" class="text-blue-700 hover:underline">{{ user.user.wca_id }}</a></p>

    <div v-if="sortedCompetitions.length" class="mt-4">
      <p class="font-semibold">Upcoming Competitions:</p>
      <table class="min-w-full border mt-2 text-left">
        <thead>
