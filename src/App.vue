<template>
  <main class="min-h-screen bg-gray-100 p-4 sm:p-6">
    <div class="max-w-6xl mx-auto bg-white p-4 sm:p-6 rounded shadow">
      <h1 class="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 text-left">
        Upcoming Comps
      </h1>
      <p class="text-base sm:text-lg font-medium text-left">
        Track upcoming competitions of the competitors you’re looking for!
      </p>
      <p class="text-sm sm:text-base font-normal mb-4 text-left">
        Note: Competitions that use an external registration website cannot be
        tracked unless the competitor list is uploaded to the WCA website.
      </p>
    ...
    <footer
      class="mt-12 border-t pt-4 text-xs sm:text-sm text-gray-500 text-center">
      <p>
        Built by
        <a
          href="https://github.com/goomseo"
          target="_blank"
